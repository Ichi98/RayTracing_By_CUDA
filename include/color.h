...
__device__ __forceinline__ double linear_to_gamma(double linear_component)
{
...
__device__ void write_color(unsigned char* out, const long long idx,const color& pixel_color) {
